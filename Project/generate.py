'''
Qualitative generation: produce continuations from a fixed set of medical +
neutral prompts using each (model, tokenizer) pair. Saves a side-by-side text
file for the report.

Uses the Sampler from Module 7 unchanged.
...
PROMPTS = [
    ...
    "The quick brown fox",   # sanity check: non-medical prompt
]
...
def main():
    ...
    ap.add_argument("--label", required=True, help="Short name shown in the output header.")
