...
Reads:
  artifacts/weights/{general_1ep,medical_1ep,general,medical}/loss_log.csv
Writes:
  artifacts/results/figures/*.png
...
def fig_token_efficiency():
    # Numbers from artifacts/results/token_efficiency.txt (also in results_1epoch.md §2)
